...
public class project extends JFrame implements ActionListener{
    ...
    project(){
        ...
        JMenuItem t4 = new JMenuItem("Employee List");
        ...
        s3.setMnemonic('T');
        s3.setIcon(new ImageIcon(ClassLoader.getSystemResource("icon/atten.png")));
        ...
        JMenuItem p2 = new JMenuItem("Attendance List");
        ...
        m8i1.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_Q,ActionEvent.CTRL_MASK));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(msg.equals("New Employee"))
        ...
        else if(msg.equals("Employee List")){
            ...
            try{
                Runtime.getRuntime().exec("C:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\chrome.exe");
            }catch(Exception e){ }
        }
        ...
        else if(msg.equals("Attendance List"))
