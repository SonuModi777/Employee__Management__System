...
public class Salary extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        String basic = t6.getText();
         ...
         String qry = "insert into salary values("+c2.getSelectedItem()+","+hra+","+da+","+med+","+pf+","+basic+")";
         
         try{
            conn c1 = new conn();
            String q = "select id from salary where id='"+c2.getSelectedItem()+"'";
            ResultSet rs = c1.s.executeQuery(q);
            if(rs.next()){
                JOptionPane.showMessageDialog(null, "Salary already created for this id, if you want to update then go for update section");
